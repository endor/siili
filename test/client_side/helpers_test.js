...
// assert.equal('1:09', helpers.time_entries_view([{minutes: 69}])[0].duration);
// 
...
// assert.equal('10.51', helpers.time_entries_view([{revenue: 1050.875}])[0].revenue);
// assert.equal('0.00', helpers.time_entries_view([{}])[0].revenue);
// 
